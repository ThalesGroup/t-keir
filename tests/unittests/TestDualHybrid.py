...
def test_load_rag_config_includes_dual_hybrid():
    ...
    assert (
        "global" in config.dual_hybrid.rrf.arm_weights
        or "chunk" in config.dual_hybrid.rrf.arm_weights
    )
    ...
    assert config.dual_hybrid.business_ontology.default_dataset == "osint"
