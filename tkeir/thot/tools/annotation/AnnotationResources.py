                    ...
                    for list_item in data_i["lists"]:
                        ...
                        if "download" in list_item:
                            if "url" in list_item["download"]:
                                try:
                                    ...
                                    ThotLogger.info(
                                        "Extract to ["
                                        + configuration["resources-base-path"]
                                        + "]"
                                    )
                                    z.extractall(
                                        path=configuration[
                                ...
                                ThotLogger.error(
                                    "With download option you must give url"
                                )
                        ...
                        if "exceptions" in list_item:
                            if not isinstance(list_item["exceptions"], list):
                                list_item["exceptions"] = [
                                    list_item["exceptions"]
                                ]
                            for except_i in list_item["exceptions"]:
                                try:
                                    with open(
                                        os.path.join(basepath, except_i)
                                    ) as exc_f:
                                        pattern_exception = set(
                                            exc_f.read().split("\n")
                                        )
                        ...
                        if ("path" in list_item) and os.path.isfile(
                            ...
                            if "pos" in list_item:
                                ...
                                ThotLogger.warning(
                                    "POS should be set, default is NOUN"
                                )
                            ...
                            if label and ("format" in list_item):
                                if "type" in list_item["format"]:
                                    if (
                                        list_item["format"]["type"] == "csv"
                                    ) or (
                                        list_item["format"]["type"]
                                        == "csv-zip"
                                    ):
                                        if (
                                            list_item["format"]["type"]
                                                ...
                                                try:
                                                    if not columns[col_i]:
                                                        ...
                                                        for ri_id in range(
                                                            ...
                                                            if pattern_text:
                                                                multiple_pattern = pattern_text.split(
                                                                    columns[
                                                                        col_i
                                                                    ]
                                                                )
                                                                for (
                                                                    ...
                                                                    mpi_text = AnnotationResources._pattern_text(
                                                                        mpi
                                                                    )
                                                                    if mpi_text:
                                                                        list_patterns.append(
                                    ...
                                    ThotLogger.error(
                                        "Format is not defined, not type."
                                    )
                            else:
                        ...
                        for e_i in range(len(list_patterns)):
                            ...
                            if "add-ascii-folding" in list_item:
                                add_ascii_folding = list_item[
                                    "add-ascii-folding"
                                ]
                            if "type" in list_item:
                                data_type = list_item["type"]
                            if pattern_text not in pattern_exception:
                                duplicate_id = (
                                    pattern_i + "#" + label + "#" + pos
                                )
