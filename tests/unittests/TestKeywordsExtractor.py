...
test_file_path = os.path.abspath(
    os.path.join(dir_path, "../fixtures/test-outputs-syntax")
)
...
class TestKeywordsExtractor(unittest.TestCase):
    ...
    def test_min_keyword_length_filters_short_keywords(self):
                ...
                "extractors": [
                    {
                        ...
                        "resources-base-path": resources_path,
                        "keywords-rules": "keywords-rules.json",
                    }
                ]
            },
        ...
        config.loads(cfg)
        extractor = KeywordsExtractor(config=config)
    ...
    def test_kwe(self):
        ...
        config = KeywordsConfiguration()
        TestKeywordsExtractor.kw_config["keywords"]["extractors"][0][
            "resources-base-path"
        ] = resources_path
        ...
        with open(
            os.path.join(
                test_file_path,
                "mail3.txt.converted.tokenized.ms.ner.syntax.json",
            )
        ) as f:
            ...
            self.assertTrue(
                ...
                == [
                    ...
                    {
                        "score": 9,
                        "text": "discussion last week",
                        "span": {"start": 3, "end": 6},
                    },
                    {
                        "score": 8,
                        "text": "certain quality specification",
                        "span": {"start": 109, "end": 112},
                    },
                    {
                        "score": 7,
                        "text": "subordinated loan agreement",
                        "span": {"start": 68, "end": 71},
                    },
                    {
                        "score": 4,
                        "text": "loan agreement",
                        "span": {"start": 179, "end": 181},
                    },
                    {
                        "score": 4,
                        "text": "other thing",
                        "span": {"start": 93, "end": 95},
                    },
                    {
                        "score": 4,
                        "text": "independent engineer",
                        "span": {"start": 122, "end": 124},
                    },
                    {
                        "score": 4,
                        "text": "pertinent document",
                        "span": {"start": 200, "end": 202},
                    },
                    {
                        "score": 3,
                        "text": "lackawanna letter",
                    ...
                    },
                    {
                        "score": 2,
                        "text": "agreement",
                        "span": {"start": 163, "end": 164},
                    },
                    {
                        "score": 1,
                        "text": "letter",
                        "span": {"start": 192, "end": 193},
                    },
                    {
                        "score": 1,
                        "text": "date",
                        "span": {"start": 126, "end": 127},
                    },
                    {
                        "score": 1,
                        "text": "information",
                    ...
                    },
                    {
                        "score": 1,
                        "text": "same",
                        "span": {"start": 63, "end": 64},
                    },
                    {
                        "score": 1,
                        "text": "analysis",
                        "span": {"start": 76, "end": 77},
                    },
                    {
                        "score": 1,
                        "text": "requirement",
                    ...
                    },
                    {
                        "score": 1,
                        "text": "production",
                        "span": {"start": 97, "end": 98},
                    },
                    {
                        "score": 1,
                        "text": "approval",
                        "span": {"start": 113, "end": 114},
                    },
                    {
                        "score": 1,
                        "text": "wait",
                    ...
                    },
                    {
                        "score": 1,
                        "text": "thought",
                        "span": {"start": 145, "end": 146},
                    },
                    {
                        "score": 1,
                        "text": "expiration",
                        "span": {"start": 189, "end": 190},
                    },
                    {
                        "score": 1,
                        "text": "office",
                        "span": {"start": 208, "end": 209},
                    },
                ]
            )
