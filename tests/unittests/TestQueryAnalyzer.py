...
def test_build_focus_query_text_accepts_string_ner_entities():
    """Dual-hybrid historically serialized NER as bare strings."""
    from thot.tools.search.generation_prompt import build_focus_query_text

    focus = build_focus_query_text(
        raw_query="Latakia Port",
        analysis={"ner_entities": ["Latakia Port"]},
    )
    assert "Latakia Port" in focus
