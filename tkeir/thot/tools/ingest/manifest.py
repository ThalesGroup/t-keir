...
def pipeline_config_sha256(config_path: Path) -> str:
    ...
    Example:
        >>> import tempfile
        >>> from pathlib import Path
        >>> from thot.tools.ingest.manifest import pipeline_config_sha256
...
def embedder_fingerprint(*, provider: str, model: str) -> str:
    ...
    Example:
        >>> from thot.tools.ingest.manifest import embedder_fingerprint
...
def idempotency_key(
    ...
    Example:
        >>> from thot.tools.ingest.manifest import idempotency_key
...
def build_manifest(
    *,
    ...
    Example:
        >>> from thot.tools.ingest.manifest import build_manifest
        >>> from thot.tools.ingest.models import EmbedderInfo, SourceInfo
