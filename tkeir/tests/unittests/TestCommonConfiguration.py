"""Title: Test Common configuration
    ...
    def test_affect_associated_environment(self):
        test_dict = {
            ...
            "associate-environment": {
                "host": "TEST_COMMON_CFG_HOST",
                "port": "TEST_COMMON_CFG_PORT",
            },
        }
        ...
        os.environ["TEST_COMMON_CFG_HOST"] = "localhost"
        os.environ["TEST_COMMON_CFG_PORT"] = "8080"
        CommonConfiguration.affect_associated_environment(try_affectation)
